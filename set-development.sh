...
rm -r $kohaplugindir/Koha/Plugin/Fi/KohaSuomi/Holdid
rm $kohaplugindir/Koha/Plugin/Fi/KohaSuomi/Holdid.pm

SCRIPT_DIR=$( cd -- "$( dirname -- "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )

ln -s "$SCRIPT_DIR/Koha/Plugin/Fi/KohaSuomi/Holdid" $kohaplugindir/Koha/Plugin/Fi/KohaSuomi/Holdid
ln -s "$SCRIPT_DIR/Koha/Plugin/Fi/KohaSuomi/Holdid.pm" $kohaplugindir/Koha/Plugin/Fi/KohaSuomi/Holdid.pm
...
DELETE FROM plugin_data where plugin_class = 'Koha::Plugin::Fi::KohaSuomi::Holdid';
DELETE FROM plugin_methods where plugin_class = 'Koha::Plugin::Fi::KohaSuomi::Holdid';
END
